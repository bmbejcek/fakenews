...
#    url = 'http://www.cnn.com/2017/06/24/us/texas-mom-arrested-hot-car-deaths/index.html'
  #  url = 'texas-mom-arrested-hot-car-deaths/index.html'
    ...
    fuzzy = str(round(fuzz.ratio(TITLE,use)/100, 2))
    ...
    if prob[0][0] >= .5:
        prob_out = str(round(prob[0][0], 2))
    else:
        prob_out = str(round(prob[0][1], 2))
    return render_template("results.html", pred = pred_out, prob = prob_out)
  #  print(fuzzy) #Brett, this 'fuzzy' variable is a string that you can use directly
